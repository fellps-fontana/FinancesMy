...
namespace MyFinances.Migrations.MyFinancesDb
{
    ...
    [Migration("20260709002614_AdicionaCartaoCategoriaLancamentoTransferenciaFatura")]
    partial class AdicionaCartaoCategoriaLancamentoTransferenciaFatura
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyFinances.Models.Lancamento", b =>
                {
                    ...
                    b.HasIndex("ContaId", "FaturaId", "Status")
                        .IsUnique()
